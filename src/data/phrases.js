...
// Phrase IDs (pid) are used for anonymous analytics tracking.
// IMPORTANT: These IDs must remain stable across app versions. Do NOT rename them.
export const CATEGORY_PHRASES = {
  quick: [
    { t: 'Yes', i: '\u2705', pid: 'yes' },
    { t: 'No', i: '\u274C', pid: 'no' },
    { t: 'Maybe', i: '\u{1F914}', pid: 'maybe' },
    { t: 'Please', i: '\u{1F64F}', pid: 'please' },
    { t: 'Thank you', i: '\u{1F49B}', pid: 'thank_you' },
    { t: 'Help!', i: '\u{1F198}', pid: 'help' },
    { t: 'Wait', i: '\u270B', pid: 'wait' },
    { t: 'Come here', i: '\u{1F44B}', pid: 'come_here' },
    { t: 'Bathroom', i: '\u{1F6BB}', pid: 'bathroom' },
    { t: 'Repeat that', i: '\u{1F504}', pid: 'repeat_that' },
    { t: 'Stop', i: '\u{1F6D1}', pid: 'stop' },
    { t: "Don't know", i: '\u{1F937}', pid: 'dont_know' },
  ],
  medical: [
    { t: 'My Info', i: '\u{1FAAA}', a: 'identity', pid: 'my_info' },
    { t: "I'm in pain", i: '\u{1F534}', a: 'pain', pid: 'im_in_pain' },
    { t: 'Need medication', i: '\u{1F48A}', pid: 'need_medication' },
    { t: 'Call the doctor', i: '\u{1F4DE}', pid: 'call_the_doctor' },
    { t: 'Feel nauseous', i: '\u{1F922}', pid: 'feel_nauseous' },
    { t: 'I need ice', i: '\u{1F9CA}', pid: 'need_ice' },
    { t: 'Jaw feels stiff', i: '\u{1F623}', pid: 'jaw_feels_stiff' },
    { t: 'Hard to breathe', i: '\u{1F630}', pid: 'hard_to_breathe' },
    { t: 'Mouth rinse', i: '\u{1FAA5}', pid: 'mouth_rinse' },
    { t: 'Swelling worse', i: '\u{1F61F}', pid: 'swelling_worse' },
    { t: 'I feel dizzy', i: '\u{1F4AB}', pid: 'feel_dizzy' },
    { t: 'Pain is better', i: '\u{1F4C9}', pid: 'pain_is_better' },
  ],
  food: [
    { t: "I'm hungry", i: '\u{1F60B}', pid: 'im_hungry' },
    { t: "I'm thirsty", i: '\u{1F4A7}', pid: 'im_thirsty' },
    { t: 'Water', i: '\u{1F4A7}', pid: 'water' },
    { t: 'Ice water', i: '\u{1F9CA}', pid: 'ice_water' },
    { t: 'Smoothie', i: '\u{1F964}', pid: 'smoothie' },
    { t: 'Warm broth', i: '\u{1F35C}', pid: 'warm_broth' },
    { t: 'Protein shake', i: '\u{1F95B}', pid: 'protein_shake' },
    { t: 'Applesauce', i: '\u{1F34E}', pid: 'applesauce' },
    { t: 'Yogurt', i: '\u{1F963}', pid: 'yogurt' },
    { t: 'Juice', i: '\u{1F9C3}', pid: 'juice' },
    { t: 'Warm tea', i: '\u{1F375}', pid: 'warm_tea' },
    { t: 'Ice cream', i: '\u{1F366}', pid: 'ice_cream' },
    { t: 'Pudding', i: '\u{1F36E}', pid: 'pudding' },
    { t: 'Soup', i: '\u{1F963}', pid: 'soup' },
    { t: 'Too hot', i: '\u{1F321}\uFE0F', pid: 'too_hot' },
    { t: 'Too cold', i: '\u2744\uFE0F', pid: 'too_cold' },
    { t: "I'm full", i: '\u270B', pid: 'im_full' },
    { t: 'Not that', i: '\u{1F645}', pid: 'not_that' },
  ],
  comfort: [
    { t: 'I need help', i: '\u{1F198}', pid: 'need_help' },
    { t: 'Bathroom', i: '\u{1F6BB}', pid: 'bathroom' },
    { t: 'Adjust pillow', i: '\u{1F6CF}\uFE0F', pid: 'adjust_pillow' },
    { t: "I'm cold", i: '\u{1F976}', pid: 'im_cold' },
    { t: "I'm hot", i: '\u{1F975}', pid: 'im_hot' },
    { t: 'Turn on TV', i: '\u{1F4FA}', pid: 'turn_on_tv' },
    { t: 'Turn off lights', i: '\u{1F4A1}', pid: 'turn_off_lights' },
    { t: 'Open window', i: '\u{1FA9F}', pid: 'open_window' },
    { t: 'Blanket', i: '\u{1F9E3}', pid: 'blanket' },
    { t: 'Sit me up', i: '\u{1FA91}', pid: 'sit_me_up' },
    { t: 'Heating pad', i: '\u2668\uFE0F', pid: 'heating_pad' },
    { t: 'Want to walk', i: '\u{1F6B6}', pid: 'want_to_walk' },
  ],
  people: [
    { t: 'I love you', i: '\u2764\uFE0F', pid: 'i_love_you' },
    { t: 'Thank you', i: '\u{1F64F}', pid: 'thank_you' },
    { t: 'Please stay', i: '\u{1F91D}', pid: 'please_stay' },
    { t: 'Need privacy', i: '\u{1F6AA}', pid: 'need_privacy' },
    { t: 'Miss you', i: '\u{1F97A}', pid: 'miss_you' },
    { t: 'Come back soon', i: '\u{1F44B}', pid: 'come_back_soon' },
  ],
  emotions: [
    { t: "I'm scared", i: '\u{1F628}', pid: 'im_scared' },
    { t: 'Frustrated', i: '\u{1F624}', pid: 'frustrated' },
    { t: "I'm sad", i: '\u{1F622}', pid: 'im_sad' },
    { t: 'Feel better', i: '\u{1F60A}', pid: 'feel_better' },
    { t: 'Nauseous', i: '\u{1F922}', pid: 'nauseous' },
    { t: 'I love you', i: '\u2764\uFE0F', pid: 'i_love_you' },
    { t: 'Grateful', i: '\u{1F979}', pid: 'grateful' },
    { t: 'Bored', i: '\u{1F610}', pid: 'bored' },
    { t: 'Tired', i: '\u{1F634}', pid: 'tired' },
    { t: 'Anxious', i: '\u{1F630}', pid: 'anxious' },
    { t: "I'm okay", i: '\u{1F44C}', pid: 'im_okay' },
    { t: 'Need a hug', i: '\u{1F917}', pid: 'need_a_hug' },
    { t: 'Leave me alone', i: '\u{1F645}', pid: 'leave_me_alone' },
    { t: 'Hopeful', i: '\u{1F31F}', pid: 'hopeful' },
    { t: 'Lonely', i: '\u{1F614}', pid: 'lonely' },
    { t: 'Embarrassed', i: '\u{1F633}', pid: 'embarrassed' },
  ],
};

// Lookup map: phrase text → phrase ID (for analytics). Built once at module load.
export const PHRASE_TEXT_TO_ID = (() => {
  const map = {};
  for (const phrases of Object.values(CATEGORY_PHRASES)) {
    for (const p of phrases) {
      if (p.pid && !map[p.t]) map[p.t] = p.pid;
    }
  }
  return map;
})();
